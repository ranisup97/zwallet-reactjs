  ...
  uploadHandler = () => {
    ...
    //  console.log('hasil dari form data: ',formData.get('images'))
      if (formData.get('images') == 'null') {
        ...
        axios.patch(`${process.env.REACT_APP_API}/user/patch_user`,{fullName:this.state.fullName},headers)
          .then(res => {
              this.dataApi()
          })
          .catch(err => {
              ...
              <div className="body-area-profile">
                ...
                <div className="row ">
                  <div className="col-12 text-center ">
                    ...
                    <img alt="" src={this.props.userData.photo} className="img-fluid profile-image" />
                  ...
                  <div className="row justify-content-center">
                    <div className="col-10 text-center">
                      <div className="mt-4 text-center position-relative">
                        ...
                        <img className="avatar" src={this.props.userData.photo} alt="" />
